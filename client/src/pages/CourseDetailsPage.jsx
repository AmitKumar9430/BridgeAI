  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        ...
        {sidebarOpen && (
          <aside className="w-full lg:w-80 shrink-0 bg-white dark:bg-slate-900 border border-slate-200 rounded-xl shadow-sm overflow-hidden lg:sticky lg:top-4 animate-fadeIn transition-all">
            {/* Top Sidebar Header */}
