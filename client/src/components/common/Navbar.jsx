    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Mobile menu trigger (guests only) */}
          {!user && (
            <button
      ...
      {/* Mobile Drawer */}
      {mobileMenuOpen && (
        <div className="lg:hidden px-4 pt-3 pb-6 bg-white dark:bg-[#0B1220] border-b border-slate-200 dark:border-slate-800 space-y-3">
          {!user && currentView === 'landing' && (
