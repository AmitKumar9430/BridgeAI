    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 sm:p-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4 transition-colors">
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          ...
          <a
            href="/BridgeAI_Platform_Presentation.html"
            download="BridgeAI_Platform_Presentation.html"
            className="px-3.5 py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-xl text-xs font-semibold transition-colors flex items-center gap-1.5 border border-slate-200 dark:border-slate-700 shadow-2xs"
            title="Download Animated Platform Presentation (HTML)"
          >
